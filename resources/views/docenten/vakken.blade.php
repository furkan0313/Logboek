        ...
        <div class="col-md-8">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <br>
                    <div class="dropdown">
                        <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Kies uw
                            klas
                            <span class="caret"></span></button>
                        <ul class="dropdown-menu">
                            <li><a href="#">HTML</a></li>
                    ...
                    <ul>
                        <li class="left clearfix">
                            ...
                            <div class="chat-body clearfix">
                                <div class="header">
                                    <strong class="primary-font">Leerling 1</strong>
                        ...
                        <li class="right clearfix">
                            ...
                            <div class="chat-body clearfix">
                                <div class="header">
                                    <strong class="pull-left primary-font">Leerling 2</strong>
                        ...
                        <li class="left clearfix">
                            ...
                            <div class="chat-body clearfix">
                                <div class="header">
                                    <strong class="primary-font">Leerling 3</strong>
                                    <small class="text-muted">32 mins ago</small>
                                </div>
                                <p>
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla ante turpis, rutrum
